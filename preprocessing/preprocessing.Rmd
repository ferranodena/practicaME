...
ord_1_10 <- function(x) {
  ...
  x <- floor(x)
  x <- pmin(pmax(x, 1), 10)
  factor(x, levels = 1:10, labels = as.character(1:10), ordered = TRUE)
}

bin_01 <- function(x) {
  x <- to_numeric_safely(x)
  b <- ifelse(is.na(x), NA, as.integer(x != 0))
  factor(b, levels = c(0, 1), labels = c("0","1"))
}

## Conversió de variables
# Curricular_units_1st_sem_enrolled -> categòrica 1..10
df$Curricular_units_1st_sem_enrolled <- ord_1_10(df$Curricular_units_1st_sem_enrolled)

# Curricular_units_2nd_sem_enrolled -> categòrica 1..10
df$Curricular_units_2nd_sem_enrolled <- ord_1_10(df$Curricular_units_2nd_sem_enrolled)

# Curricular_units_1st_sem_credited -> binària 0/1
df$Curricular_units_1st_sem_credited <- bin_01(df$Curricular_units_1st_sem_credited)

# Curricular_units_2nd_sem_credited -> binària 0/1
df$Curricular_units_2nd_sem_credited <- bin_01(df$Curricular_units_2nd_sem_credited)

# Curricular_units_1st_sem_evaluations -> categòrica 1..10
df$Curricular_units_1st_sem_evaluations <- ord_1_10(df$Curricular_units_1st_sem_evaluations)

# Curricular_units_2nd_sem_evaluations -> categòrica 1..10
df$Curricular_units_2nd_sem_evaluations <- ord_1_10(df$Curricular_units_2nd_sem_evaluations)

# Curricular_units_1st_sem_approved -> categòrica 1..10
df$Curricular_units_1st_sem_approved <- ord_1_10(df$Curricular_units_1st_sem_approved)

# Curricular_units_2nd_sem_approved -> categòrica 1..10
df$Curricular_units_2nd_sem_approved <- ord_1_10(df$Curricular_units_2nd_sem_approved)

# Curricular_units_1st_sem_without_evaluations -> binària 0/1
df$Curricular_units_1st_sem_without_evaluations <- bin_01(df$Curricular_units_1st_sem_without_evaluations)

# Curricular_units_2nd_sem_without_evaluations -> binària 0/1
df$Curricular_units_2nd_sem_without_evaluations <- bin_01(df$Curricular_units_2nd_sem_without_evaluations)

...
if ("" %in% names(df)) {
  x <- to_numeric_safely(df$Application_order)
  df$Application_order <- factor(x, levels = ordinal_levels, labels = ordinal_labels, ordered = TRUE)
}

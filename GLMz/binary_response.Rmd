...
AIC(m0.1, m0.3, m0.5)
```
No hi ha cap millora substancial com per justificar aquests canvis, ens quedem amb el m0.1
...
BIC(m0.1, m_probit)
```
No millora amb el link probit, mantenim el model m0.1
